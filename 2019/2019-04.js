...
console.log(sort20190430([1, 2, 3, 50, -88, 65, -4, 89, 1111]));

//  快排
const quickSort20190430 = arr => {
...
console.log(quickSort20190430([1, 2, 3, 50, -88, 65, -4, 89, 1111]));
